...
!function ( $ ) { 
  ...
  DatePicker.prototype = {
    ...
    , nav: function( c, months ) {
        var $subnav = $('<div>' +
                          '<span class="prev button"><i class="icon-arrow-left"/></span>' +
                          '<span class="name"></span>' +
                          '<span class="next button"><i class="icon-arrow-right"/></span>' +
                        '</div>').addClass(c)
  ...
  $.fn.datepicker.defaults = {
    monthNames: ["Janvier", "F&eacute;vrier", "Mars", "Avril", "Mai", "Juin",
                 "Juillet", "Ao&ucirc;t", "Septembre", "Octobre", "Novembre", "Decembre"]
